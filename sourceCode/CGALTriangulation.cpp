...
void CGALTriangulation::Triangulate(std::vector<glm::vec2> boundary, std::vector<ATriangle>& triangles)
{
	Polygon_2 polygon1;
		...
		fit != cdt.finite_faces_end(); ++fit)
	{
		...
		{
			ATriangle tri((*(fit->vertex(0))).info(), (*(fit->vertex(1))).info(), (*(fit->vertex(2))).info());
